...
exports.MobileSignalsRuntime = void 0;
const signals_runtime_1 = require("../shared/signals-runtime");
class MobileSignalsRuntime extends signals_runtime_1.SignalsRuntime {
    constructor(signals = []) {
        super(signals);
        this._add = (signal) => {
...
exports.MobileSignalsRuntime = MobileSignalsRuntime;
