...
declare interface BaseNavigationData {
    currentUrl: string;
    hash: string;
    search: string;
    path: string;
 ...
 */
 ...
 declare type ChangedProperties = 'path' | 'search' | 'hash';
...
declare interface NetworkResponseData extends BaseNetworkData {
 ...
 declare interface PageChangeNavigationData extends BaseNavigationData {
}
...
declare type SubmitData = {
 ...
 declare interface URLChangeNavigationData extends BaseNavigationData {
    previousUrl: string;
