...
const parseToLabel = (label) => {
    const textContent = label.textContent ? (0, helpers_1.cleanText)(label.textContent) : "";
    return {
        id: label.id,
...
const parseElement = (el) => {
    ...
    const base = {
        ...
        textContent: (el.textContent && (0, helpers_1.cleanText)(el.textContent)) ?? undefined,
        innerText: (el.innerText && (0, helpers_1.cleanText)(el.innerText)) ?? undefined,
