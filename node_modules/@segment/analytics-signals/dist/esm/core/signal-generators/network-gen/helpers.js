 ...
 */
export const getDomainFromHost = (hostName) => {
 ...
 */
export const containsContentType = (headers, match) => {
    if (!headers) {
        return false;
    }
...
export const containsJSONContentType = (Headers) => {
...
export const containsJSONParseableContentType = (headers) => {
    return (containsJSONContentType(headers) ||
 ...
 */
export const normalizeRequestInfo = (requestInfo) => {
